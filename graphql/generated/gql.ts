...
type Documents = {
    ...
    "query SortRecipe($sortBy: SortByEnum!) {\n  sortRecipes(sortBy: $sortBy) {\n    id\n    title\n    slug\n    description\n    likes {\n      userId\n    }\n    tag {\n      name\n    }\n    views {\n      userId\n    }\n    createdAt\n    updatedAt\n  }\n}": typeof types.SortRecipeDocument,
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query SortRecipe($sortBy: SortByEnum!) {\n  sortRecipes(sortBy: $sortBy) {\n    id\n    title\n    slug\n    description\n    likes {\n      userId\n    }\n    tag {\n      name\n    }\n    views {\n      userId\n    }\n    createdAt\n    updatedAt\n  }\n}"): (typeof documents)["query SortRecipe($sortBy: SortByEnum!) {\n  sortRecipes(sortBy: $sortBy) {\n    id\n    title\n    slug\n    description\n    likes {\n      userId\n    }\n    tag {\n      name\n    }\n    views {\n      userId\n    }\n    createdAt\n    updatedAt\n  }\n}"];
